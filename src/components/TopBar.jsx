    ...
    return (
      <div ref={mobileMenuRef}>
        <header style={{
          ...
          {/* ── Row 1: back · logo · hamburger ── */}
          <div style={{
            display: 'flex', alignItems: 'center', justifyContent: 'space-between',
            padding: '0 14px', height: '60px', flexShrink: 0,
          }}>
            {/* Left: back button placeholder keeps logo centred */}
            <div style={{ width: '34px', display: 'flex', alignItems: 'center' }}>
              {activeView !== 'home' && (
                <button
                  onClick={() => navigateTo('home')}
                  style={{ width: '36px', height: '36px', borderRadius: 'var(--r-full)', background: 'rgba(124,58,237,0.15)', color: 'var(--text-primary)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '1.15rem', fontWeight: 700, border: '1.5px solid rgba(124,58,237,0.4)' }}
                >←</button>
              )}
            </div>
            ...
            <div
              onClick={() => navigateTo('home')}
              style={{ fontSize: '1.25rem', fontWeight: 900, fontFamily: 'var(--font-display)', background: 'linear-gradient(135deg,#7c3aed,#ec4899)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', cursor: 'pointer', letterSpacing: '0.04em' }}
            >
              MUSIC IQ
            </div>
            ...
            <button
              ...
              style={{ width: '34px', height: '34px', borderRadius: 'var(--r-sm)', background: mobileMenuOpen ? 'var(--bg-hover-item)' : 'var(--bg-topbar-btn)', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: '4px', position: 'relative', transition: 'background 0.2s' }}
          ...
          {/* ── Row 2: page title ── */}
          <div style={{ height: '56px', padding: '0 18px', display: 'flex', alignItems: 'center', borderTop: '1px solid var(--border)' }}>
            <h1 style={{ margin: 0, fontSize: '1rem', fontWeight: 700, fontFamily: 'var(--font-display)', color: 'var(--text-primary)' }}>
              {currentTitle}
            </h1>
          </div>
        </header>
  ...
  return (
    <header style={{
      ...
      <div style={{ flex: 1, display: 'flex', justifyContent: 'center' }}>
        <div
          onClick={() => navigateTo('home')}
          style={{ fontSize: '1.5rem', fontWeight: 900, fontFamily: 'var(--font-display)', background: 'linear-gradient(135deg,#7c3aed,#ec4899)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', cursor: 'pointer', letterSpacing: '0.04em' }}
        >
          MUSIC IQ
        </div>
      </div>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '12px', flex: 1, justifyContent: 'flex-end' }}>
        ...
        <div ref={dropdownRef} style={{ position: 'relative' }}>
          <button
            ...
            style={{ width: '40px', height: '40px', borderRadius: '10px', background: 'linear-gradient(135deg,#7c3aed,#ec4899)', color: '#fff', fontWeight: 'bold', border: '3px solid var(--bg-topbar)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '0.9rem', transition: 'transform 0.2s' }}
