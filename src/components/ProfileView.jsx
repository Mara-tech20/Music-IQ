    ...
    <div style={{ padding: '24px', maxWidth: '900px', margin: '0 auto', animation: 'fadeIn 0.4s ease', display: 'flex', flexDirection: 'column', gap: '24px' }}>
      ...
      {showNameModal && (
        <div style={{ position: 'fixed', inset: 0, zIndex: 1050, display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'rgba(0,0,0,0.92)', backdropFilter: 'blur(8px)', animation: 'modalOverlayIn 0.3s ease' }}>
          <div className="glass-modal" style={{ width: '90%', maxWidth: '440px', padding: '32px 28px', animation: 'modalSlideUp 0.4s cubic-bezier(0.175,0.885,0.32,1.275)' }}>
      ...
      {showPwModal && (
        <div style={{ position: 'fixed', inset: 0, zIndex: 1050, display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'rgba(0,0,0,0.92)', backdropFilter: 'blur(8px)', animation: 'modalOverlayIn 0.3s ease' }}>
          <div className="glass-modal" style={{ width: '90%', maxWidth: '460px', padding: '32px 28px', animation: 'modalSlideUp 0.4s cubic-bezier(0.175,0.885,0.32,1.275)' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '24px' }}>
